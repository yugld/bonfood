...
class ClassLoader
{
     ...
     * @var array<array>
     *
     * @psalm-var array<string, array<string, array<string>>>
     */
    ...
    /**
     * @return array<string> Array of classname => path
     *
     * @psalm-return array<string, string>
     */
    ...
    /**
     * @param array<string> $classMap Class to filename map
     *
     ...
     * @param array<string>|string $paths   The PSR-0 root directories
     ...
     * @param array<string>|string $paths   The PSR-4 base directories
     * @param bool            $prepend Whether to prepend the directories
     *
     ...
     *
     * @param string          $prefix The prefix
     * @param array<string>|string $paths  The PSR-0 base directories
     *
     * @return void
     */
