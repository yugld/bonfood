...
trait MessageTrait
{
    /** @var array<array<string>> Map of all registered headers, as original name => array of values */
    private $headers = [];
     ...
     * OWS          = *( SP / HTAB )
     *
     * @param array<mixed> $values Header values
     *
     * @return array<string> Trimmed header values
     *
